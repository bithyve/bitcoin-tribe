...
const IfaMetaDataScreen = () => {
  ...
  const coin = useObject<InflatableFungibleAsset>(RealmSchema.IFA, assetId);
  ...
  useEffect(() => {
    if (!coin.metaData) {
      mutate({ assetId, schema: RealmSchema.IFA });
    }
  }, []);
  useEffect(() => {
  ...
  const hideAsset = () => {
    dbManager.updateObjectByPrimaryId(RealmSchema.IFA, 'assetId', assetId, {
          ...
          <>
            <PostOnTwitterModal
              ...
              primaryOnPress={() => {
                ...
                updateAssetPostStatus(coin, RealmSchema.IFA, assetId, false);
                updateAssetIssuedPostStatus(RealmSchema.IFA, assetId, true);
          ...
          <>
            <IssueAssetPostOnTwitterModal
              ...
              primaryOnPress={() => {
                ...
                setRefresh(prev => !prev);
                updateAssetIssuedPostStatus(RealmSchema.IFA, assetId, false);
              }}
              secondaryOnPress={() => {
                setVisibleIssuedPostOnTwitter(false);
...
export default IfaMetaDataScreen;

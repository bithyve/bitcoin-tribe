...
function FailedToCreatePopupContainer(props: insufficientBalanceProps) {
    ...
    <View>
      <View style={styles.infoWrapper}>
        <AppText variant="heading1" style={styles.headerText}>
          {assets.failedToCreateUTXOTitle}
        </AppText>
        <AppText variant="body1" style={styles.subTitleText}>
          {assets.failedToCreateUTXOSubTitle}
        </AppText>
      </View>
...
export default FailedToCreatePopupContainer;

import React, {
  ...
  function IssueIfa() {
    ...
    }, [assetName, assetTicker, navigation, totalSupplyAmt, precision, replaceRightsNum]);
          ...
          <View>
            ...
            <TextField
              ...
              onChangeText={text => {
                if (!text.trim()) {
                  setReplaceRightsNum('');
                  setReplaceRightsNumValidationError(assets.enterReplaceRightsNum);
                } else {
                  setReplaceRightsNum(text);
                  setReplaceRightsNumValidationError(null);
                }
              }}
              placeholder={assets.enterReplaceRightsNumPlaceholder}
              keyboardType="numeric"
              style={styles.input}
              returnKeyType="next"
              onSubmitEditing={Keyboard.dismiss}

...
import BackupOnboardingScreen from 'src/screens/onBoarding/BackupOnboardingScreen';
...
function LoginStack() {
  ...
  return (
    <Stack.Navigator
      ...
      />
      <Stack.Screen
        name={NavigationRoutes.BACKUPONBOARDINGSCREEN}
        component={BackupOnboardingScreen}
      />

...
export default class Node {
  ...
  public static update(nodeDetail: NodeDetail, propsToUpdate: any) {
    ...
    const schema = nodeDetail.isDefault
      ? RealmSchema.DefaultNodeConnect
  ...
  public static getAllNodes(): NodeDetail[] {
    const defaultNodes: NodeDetail[] = dbManager.getCollection(
      RealmSchema.DefaultNodeConnect,
    );
    const personalNodes: NodeDetail[] = dbManager.getCollection(
      RealmSchema.NodeConnect,
    );
  ...
  public static async disconnect(selectedNode: NodeDetail) {
    ...
    if (
      ...
      selectedNode.port === activePeer?.port
    ) {

...
RCT_EXPORT_METHOD(sendAsset:(NSString*)assetId blindedUTXO:(NSString *)blindedUTXO amount:(nonnull NSNumber *)amount consignmentEndpoints:(NSString *)consignmentEndpoints fee:(nonnull NSNumber *)fee isDonation:(BOOL)isDonation schema:(NSString *)schema witnessSats:(nonnull NSNumber *)witnessSats resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
  EXEC_ASYNC({
    RGBHelper *helper = [[RGBHelper alloc] init];
    [helper sendAssetWithAssetId:assetId blindedUTXO:blindedUTXO amount:amount consignmentEndpoints:consignmentEndpoints fee:fee isDonation:isDonation schema: schema witnessSats: witnessSats callback:^(NSString * _Nonnull response) {
      [self resolvePromise:resolve withResult:response];
    }];
  });
}
...
RCT_EXPORT_METHOD(getRgbDir:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
  EXEC_ASYNC({
    RGBHelper *helper = [[RGBHelper alloc] init];
